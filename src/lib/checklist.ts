    ...
    <script>
      ...
      function buildReportListHtml(key, title, emptyText) {
        const script =
          ...
          "window.__openSavedReport=function(id){var found=readReports().find(function(r){return r.id===id});if(found&&found.html)__openBlobHtml(__prepareReportHtml(found.html));};" +
          "render();";
        const body =
